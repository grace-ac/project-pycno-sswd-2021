...
Note: Sick samples are those that were sampled at or during disease sign development
Sick :       Libary ID:
H01                 PSC.59
H03                 PSC.63 (toher option: PSC.73 a day after)
H04                 PSC.69
H05                 PSC.58 (other option: PSC.64 a day after)
H06                 PSC.57
H07                 PSC.83
H08                 PSC.75
H09                 PSC.67
...
```{r}
counts_hvs <- countmatrix[,c("PSC.56","PSC.81","PSC.61","PSC.76","PSC.52","PSC.42","PSC.37","PSC.54","PSC.59","PSC.63","PSC.69","PSC.58","PSC.57","PSC.83","PSC.75","PSC.67")]
head(counts_hvs)
```
