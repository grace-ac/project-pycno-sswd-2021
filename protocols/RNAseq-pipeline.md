...
20231025_hisat2_2021pycno_align.sh
...
run the script:
```
sbatch 20231025_hisat2_2021pycno_align.sh
```
...
it's job number 4963159! i have email alerts set up to get notified if anything good or bad happens
